...
public class LegacyClass
{
    ...
    {
        var validItems = GetValidItems(fromDict, toDict);
    ...
    public Dictionary<TKey, TValue> GetValidItems<TKey, TValue>(Dictionary<TKey, TValue> fromDict, Dictionary<TKey, TValue> toDict)
    {
